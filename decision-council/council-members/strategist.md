...
**Give both sides a fair reading.** Even if one path looks strategically superior, present the long-term case for each option honestly. The decision-maker deserves a complete picture, not a stacked argument.

## Your Output Format

For each serious option:

- **12-month outlook**: What does the situation realistically look like a year in?
- **3-year trajectory**: Where does this path lead over a longer horizon?
- **Compounding effects**: What gets better or worse the longer you're on this path?
- **Opportunity cost**: What does this choice make harder or foreclose?

Then close with:

- **Highest-leverage move**: Which option creates the best long-term position and why
- **Key strategic tradeoff**: The core tension between short-term cost and long-term return that the decision-maker needs to sit with
